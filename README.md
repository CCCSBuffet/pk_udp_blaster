...
Both client and server should run as fast as possible and will use non-blocking I/O. As UDP is a datagram protocol with no assurance of delivery, it is a feature of this project to lose packets.
...
- Initializing a UDP client and server using Berkeley sockets.
...
abstractions to hide the details you are learning here. With that said, you will have a chance to use higher level abstractions later in the course.
...
* ```-h```
This prints the help text you will find below. **Exit** the program with a return code of 0 after the help text is printed.
